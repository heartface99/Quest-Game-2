...
public class Character extends Character_monster implements HeroFightAbility {
    ...
    */
    ...
    /*The following functions are various setters to manipulate different attributes of the hero*/
    ...
    public void printSpellSale(){
        // outputs print statements that show the selling of a spell
        Spells current;
        String name;
        String cost;
    ...
    public void printPotionSale(){
        // outputs print statements that show the selling of a potion
        Potion current;
        String name;
        String cost;
        String required_level;
    ...
    public void printArmorSale(){
        // outputs print statements that show the selling of armor
        Armor current;
        String name;
        String cost;
        String required_level;
    ...
    public void printWeaponSale(){
        // outputs print statements that show the selling of a weapon
        Weapon current;
        String name;
        String cost;
        String required_level;
    ...
    public void damagetaken(int damage){
        // Called when a monster attacks a hero
        int hpnow;
    ...
    /*The following are different actions a hero can do to sell at a market*/
    ...
    /*end of cell market options*/


    public void equipArmor(Armor x){
        // equip armor on a hero
